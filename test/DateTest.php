...
class DateTest extends TestCase
{
    ...
    {
        $timestamp = strtotime('2018-10-15T00:00:00Z');
    ...
    {
        $date              = new Date('2018-10-20');
        $expectedTimestamp = strtotime('2018-10-20T00:00:00Z');
        ...
        $this->assertEquals($localTimeZone, $dateTime->getTimezone());
        ...
        $dateTimeBerlin = $date->getDateTime('Europe/Berlin');
        $this->assertNotEquals($dateTimeBerlin->getTimestamp(), $dateTimeUtc->getTimestamp());
    }
    ...
    public function testIsDateOnlyForDate()
    {
        $this->markTestIncomplete('TODO tests for handling of isDateOnly');
    }
}
