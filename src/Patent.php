...
class Patent extends AbstractModel
{
    ...
    public const FIELD_DATE_GRANTED = 'DateGranted';
    public const FIELD_NUMBER       = 'Number';
    public const FIELD_YEAR_APPLIED = 'YearApplied';
    ...
    protected static function loadModelConfig()
    {
        return [
            'fields' => [
                ...
                self::FIELD_COUNTRIES    => [],
                self::FIELD_DATE_GRANTED => [
                    'type' => 'Date',
                ],
                self::FIELD_NUMBER       => [],
                self::FIELD_YEAR_APPLIED => [
                    'type' => 'int',
                ],
            ],
        ];
